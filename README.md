...
**Stable release: [`v1.0.0`](https://github.com/emaraschio/cursor-commands/releases/tag/v1.0.0)** — Generic Cursor slash commands, Agent Skills, and behavioral eval rubrics. Ship-gate sections are enforced in CI via [docs/EVAL_CI.md](docs/EVAL_CI.md). Organization-specific packs install from the **host workspace**.
