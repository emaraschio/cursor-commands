...
- **29** generic slash commands (git, review, security audits, agent risk review, PR workflows, requirement-to-implementation, etc.)
- **29** skill directories (one per command)
