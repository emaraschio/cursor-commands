...
- **31** generic slash commands (git, review, security audits, agent risk review, scoped parallel audits, workspace git sync, PR workflows, requirement-to-implementation, etc.)
- **31** skill directories (one per command)
