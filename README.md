...
- **30** generic slash commands (git, review, security audits, agent risk review, scoped parallel audits, PR workflows, requirement-to-implementation, etc.)
- **30** skill directories (one per command)
