...
- [x] Ship-gate rows: **98** (plan estimated ~92; includes `D3b` and full A-section on merge-open-prs)
- [x] Commands with eval + ship gate: **28** (target 27)
- [x] `fixture_ready: y`: **90** | `n`: **8**
