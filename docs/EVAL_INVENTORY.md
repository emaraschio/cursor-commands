...
- [x] Ship-gate rows: **114** (plan estimated ~92; includes `D3b` and full A-section on merge-open-prs)
- [x] Commands with eval + ship gate: **32** (target 27)
- [x] `fixture_ready: y`: **106** | `n`: **8**
