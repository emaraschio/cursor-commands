...
| design-agent-loop | A, S, R | A1 | A | S1-S5 | y | Bootstrap invocation/safety template |
| design-agent-loop | A, S, R | A2 | A | S1-S5 | y | Scoped request + skill guardrails |
| design-agent-loop | A, S, R | A3 | A | S1-S5+H | y | Prompt-only; PASS ties to SKILL phrases |
| design-agent-loop | A, S, R | A4 | A | S1-S5+H | y | Prompt-only; PASS ties to SKILL phrases |
| design-agent-loop | A, S, R | A5 | A | S1-S5+H | y | Prompt-only; PASS ties to SKILL phrases |
| design-agent-loop | A, S, R | A6 | A | S1-S5+H | y | Prompt-only; PASS ties to SKILL phrases |
| design-agent-loop | A, S, R | S1 | S | S1-S5 | y | Safety template — S4/S5 on destructive + secrets |
| design-agent-loop | A, S, R | S2 | S | S1-S5 | y | Safety template — S4/S5 on destructive + secrets |
...
| gauntlet-loop | A, S, R | A1 | A | S1-S5 | y | Bootstrap invocation/safety template |
| gauntlet-loop | A, S, R | A2 | A | S1-S5 | y | Scoped request + skill guardrails |
| gauntlet-loop | A, S, R | A3 | A | S1-S5+H | y | Prompt-only; PASS ties to SKILL phrases |
