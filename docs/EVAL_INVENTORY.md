...
- [x] Ship-gate rows: **94** (plan estimated ~92; includes `D3b` and full A-section on merge-open-prs)
- [x] Commands with eval + ship gate: **27** (target 27)
- [x] `fixture_ready: y`: **86** | `n`: **8**
