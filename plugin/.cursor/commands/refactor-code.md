...
Refactor for clarity without behavior change. Full workflow: `.cursor/skill-contracts/refactor-code/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/refactor-code/SKILL.md` for the full agent contract.
