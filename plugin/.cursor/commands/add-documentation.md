...
requires_skill: true
eval:
  path: .cursor/skill-contracts/add-documentation/eval/cases.md
  ship_gate: [A]
---

## Overview

Add or improve code documentation for the current change. Full workflow: `.cursor/skill-contracts/add-documentation/SKILL.md` (user install: `~/.cursor/skill-contracts/add-documentation/SKILL.md`).
...
1. **Read** `.cursor/skill-contracts/add-documentation/SKILL.md` for the full agent contract; if that file is missing, read `~/.cursor/skill-contracts/add-documentation/SKILL.md`.
...
Behavioral eval: `.cursor/skill-contracts/add-documentation/eval/cases.md`. Ship gate sections: **A** before changing `SKILL.md` or this command.
