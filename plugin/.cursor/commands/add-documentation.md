...
Add or improve code documentation for the current change. Full workflow: `.cursor/skill-contracts/add-documentation/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/add-documentation/SKILL.md` for the full agent contract.
