...
Update project README for current state. Full workflow: `.cursor/skill-contracts/update-readme/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/update-readme/SKILL.md` for the full agent contract.
