...
Profile and optimize performance bottlenecks. Full workflow: `.cursor/skill-contracts/optimize-performance/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/optimize-performance/SKILL.md` for the full agent contract.
