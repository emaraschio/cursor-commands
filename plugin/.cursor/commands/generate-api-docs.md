...
Generate API documentation from code. Full workflow: `.cursor/skill-contracts/generate-api-docs/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/generate-api-docs/SKILL.md` for the full agent contract.
