...
requires_skill: true
eval:
  path: .cursor/skill-contracts/fix-compile-errors/eval/cases.md
  ship_gate: [A]
---

## Overview

Fix compilation/type errors with minimal diff. Full workflow: `.cursor/skill-contracts/fix-compile-errors/SKILL.md` (user install: `~/.cursor/skill-contracts/fix-compile-errors/SKILL.md`).
...
1. **Read** `.cursor/skill-contracts/fix-compile-errors/SKILL.md` for the full agent contract; if that file is missing, read `~/.cursor/skill-contracts/fix-compile-errors/SKILL.md`.
...
Behavioral eval: `.cursor/skill-contracts/fix-compile-errors/eval/cases.md`. Ship gate sections: **A** before changing `SKILL.md` or this command.
