...
Fix compilation/type errors with minimal diff. Full workflow: `.cursor/skill-contracts/fix-compile-errors/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/fix-compile-errors/SKILL.md` for the full agent contract.
