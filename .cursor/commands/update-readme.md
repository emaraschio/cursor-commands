...
requires_skill: true
eval:
  path: .cursor/skill-contracts/update-readme/eval/cases.md
  ship_gate: [A]
---

## Overview

Update project README for current state. Full workflow: `.cursor/skill-contracts/update-readme/SKILL.md` (user install: `~/.cursor/skill-contracts/update-readme/SKILL.md`).
...
1. **Read** `.cursor/skill-contracts/update-readme/SKILL.md` for the full agent contract; if that file is missing, read `~/.cursor/skill-contracts/update-readme/SKILL.md`.
...
Behavioral eval: `.cursor/skill-contracts/update-readme/eval/cases.md`. Ship gate sections: **A** before changing `SKILL.md` or this command.
