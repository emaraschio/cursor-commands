...
Add consistent error handling to the targeted code. Full workflow: `.cursor/skill-contracts/add-error-handling/SKILL.md` (user install: `~/.cursor/skill-contracts/add-error-handling/SKILL.md`).
...
1. **Read** `.cursor/skill-contracts/add-error-handling/SKILL.md` for the full agent contract; if that file is missing, read `~/.cursor/skill-contracts/add-error-handling/SKILL.md`.
