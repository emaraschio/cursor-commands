...
Thorough PR code review before approval. Full workflow: `.cursor/skill-contracts/code-review/SKILL.md` (user install: `~/.cursor/skill-contracts/code-review/SKILL.md`).
...
1. **Read** `.cursor/skill-contracts/code-review/SKILL.md` for the full agent contract; if that file is missing, read `~/.cursor/skill-contracts/code-review/SKILL.md`.
