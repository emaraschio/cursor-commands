...
Diagnose and fix git state problems. Full workflow: `.cursor/skill-contracts/fix-git-issues/SKILL.md` (user install: `~/.cursor/skill-contracts/fix-git-issues/SKILL.md`).
...
1. **Read** `.cursor/skill-contracts/fix-git-issues/SKILL.md` for the full agent contract; if that file is missing, read `~/.cursor/skill-contracts/fix-git-issues/SKILL.md`.
