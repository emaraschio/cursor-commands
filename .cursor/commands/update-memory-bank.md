...
Sync memory bank with repository state. Full workflow: `.cursor/skill-contracts/update-memory-bank/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/update-memory-bank/SKILL.md` for the full agent contract.
