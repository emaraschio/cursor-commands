...
Audit UI for WCAG accessibility issues and fixes. Full workflow: `.cursor/skill-contracts/accessibility-audit/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/accessibility-audit/SKILL.md` for the full agent contract.
