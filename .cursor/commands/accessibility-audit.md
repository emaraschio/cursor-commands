...
requires_skill: true
eval:
  path: .cursor/skill-contracts/accessibility-audit/eval/cases.md
  ship_gate: [A, S]
---

## Overview

Audit UI for WCAG accessibility issues and fixes. Full workflow: `.cursor/skill-contracts/accessibility-audit/SKILL.md` (user install: `~/.cursor/skill-contracts/accessibility-audit/SKILL.md`).
...
1. **Read** `.cursor/skill-contracts/accessibility-audit/SKILL.md` for the full agent contract; if that file is missing, read `~/.cursor/skill-contracts/accessibility-audit/SKILL.md`.
...
Behavioral eval: `.cursor/skill-contracts/accessibility-audit/eval/cases.md`. Ship gate sections: **A, S** before changing `SKILL.md` or this command.
