...
Run project linters and fix findings repo-wide. Full workflow: `.cursor/skill-contracts/lint-suite/SKILL.md`.
...
1. **Read** `.cursor/skill-contracts/lint-suite/SKILL.md` for the full agent contract.
