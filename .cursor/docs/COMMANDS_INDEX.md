...
| `agent-work-receipt` | generic | yes | [cases](../skills/agent-work-receipt/eval/cases.md) | A, S | — |
...
| `prompt-eval-debug` | generic | yes | [cases](../skills/prompt-eval-debug/eval/cases.md) | A, S | — |
...
| `structure-prompt` | generic | yes | [cases](../skills/structure-prompt/eval/cases.md) | A, S | — |
