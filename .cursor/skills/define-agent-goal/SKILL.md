...
description: >-
  ...
  can run with minimal babysitting. Plan-only — does not execute the task.
...
Aim for **4–6** non-obvious questions. Skip questions the user already answered.

### Phase 2 — Draft Goal

Fill the **Goal template** below. Keep the deliverable **one page** (~500–900 words): prefer tables and bullets over long prose.
...
1. Post the final Goal in chat using the template headings (sections 1–6).
